...
public class PgCatalogITest extends IntegTestCase {
    ...
    public void testPgSettingsTable() {
        ...
        assertThat(response).hasRows(
            ...
            "optimizer_reorder_join_plan| true| Indicates if the optimizer rule ReorderJoinPlan is activated.| NULL| NULL",
            ...
            "optimizer_rewrite_join_plan| true| Indicates if the optimizer rule RewriteJoinPlan is activated.| NULL| NULL",
